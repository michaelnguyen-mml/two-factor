...
class Two_Factor_Totp extends Two_Factor_Provider {
	...
	public function user_two_factor_options( $user ) {
		...
		<?php if ( empty( $key ) ) :
			...
			$totp_title = apply_filters( 'two_factor_totp_title', $site_name, $user );
			?>
			<p>
			...
			<p>
				<img src="<?php echo esc_url( $this->get_google_qr_code( $user->user_login, $key, $totp_title ) ); ?>" id="two-factor-totp-qrcode" />
			</p>
			<p>
